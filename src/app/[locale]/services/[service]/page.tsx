...
import { billboardData, ServiceCard, services } from '../../../../../public/assets/data';
...
function Service() {
  ...
  return (
    <div className="spacey-y-4 lg:space-y-6 px-4 lg:px-0">
      <div className="relative spacey-y-4 lg:space-y-6 py-4 lg:py-10">
        ...
        <div className="space-y-[24px] mt-3 lg:mt-0">
          <div className="mx-auto max-w-7xl px-[32px] lg:px-4 space-y-[24px]">
            ...
            {/* <p className="text-foreground-secondary text-[16px] tracking-[-.01em] leading-[24px] max-w-[30rem]">
              {service.description}
            </p> */}
          ...
          <div className="mx-auto max-w-7xl px-[32px] lg:px-4 mt-10 lg:mt-20">
            <div>
              <Image
                width={200}
                height={400}
                className="w-full h-[35rem] object-cover rounded-2xl"
                src="/assets/service/billboard.avif"
                alt="service gif"
              />
              <div className="grid grid-cols-1 md:grid-cols-3 py-10">
                <h4 className="text-foreground-secondary text-[18px] tracking-[-.01em] leading-[24px] font-medium">
                ...
                <div className="col-span-2">
                  ...
                  <div className="flex items-center gap-3 mt-4">
                    <Badge variant="secondary" className="p-3 py-2 gap-2">
                      ...
                      <span>Hozirda {serviceBillboardData.length}ta mavjud</span>
                    </Badge>
                    <Badge variant="secondary" className="p-3 py-2 gap-2">
          ...
          <PortfolioSection className="bg-transparent" />
